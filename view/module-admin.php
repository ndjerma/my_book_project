<section class="user-page container">
    ...
    <form class="login-form" method="post" action="./index.php?module=admin.php">
      ...
      <input type="text" name="book_author_name" required>

      <label for="book_date_published">Datum objavljivanja:</label>
      <input type="date" name="book_date_published" required>
